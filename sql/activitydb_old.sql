...
(14, '測試活動01', '2023-12-31 00:51:00', '2023-12-31 00:53:00', '', '', '', 0, '2023-12-31 00:52:00', '', '已結束', 0, 1, 1, '', 0, '', 0),
...
INSERT INTO `blacklist` (`id`, `reason`, `datetime`) VALUES
('1102963', '在 測試活動01 未簽到', '2023-12-31 00:53:02');
...
--
ALTER TABLE `activity`
  MODIFY `activity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
