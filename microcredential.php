...
<body>
    ...
    <div class="container">
        ...
        <div class="row checkbox-row justify-content-end" id="checkbox-course" style="margin-top: 20%;">
        ...
        <div class="row row-cols-1 g-4 row-cols-md-3" style="margin-top: 15%; width: 120%;"> <!-- 橫排列印所有活動卡片 -->
            <?php
            ...
            ?>
                    <div clss="col" style="min-width: 22rem; max-width: 25rem;">
                        <div class="card border-dark mb-10" style="min-width: 22rem; max-width: 25rem;">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">課程開始時間: <?php echo $row['start_date_time']; ?></li>
                                    <li class="list-group-item">課程結束時間: <?php echo $row['end_date_time']; ?></li>
